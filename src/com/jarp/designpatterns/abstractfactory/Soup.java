...
public abstract class Soup {
	...
	{
		StringBuffer stringOfIngrendients = new StringBuffer(soupName);
		
		stringOfIngrendients.append(" Ingredients ");
		
		ListIterator soupIterator = soupIngredients.listIterator();
		
		while(soupIterator.hasNext())
		{
			stringOfIngrendients.append((String)soupIterator.next());
			
		}
		
		return stringOfIngrendients.toString();
	}
